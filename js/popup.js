...
function insertPopupData() {
  ...
  popupDiv.appendChild(createLabel("publisherDropDownBook", "Serie:"));
  ...
  //Original price book
  popupDiv.appendChild(createLabel("originalPriceInput", "Orginal pris:"));
  inputElement(createInput("text", "originalPriceInput"), "input");
